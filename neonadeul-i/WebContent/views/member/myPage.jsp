...
<body>
    <div class="wrap">
        <div id="mypage">
            ...
            <div id="mypage-filter" align="right">
            ...
            <div id="mypage-outmem" align="right" >
                <button type="button" id="update-mem" data-toggle="modal" data-target="#inputPwdModal">정보수정</button>
              ...
              if($()){
                /*무엇인가를 적어보자. 비밀번호가 맞지않으면 안된다. 뭐 그런거?*/
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="ntn btn-warning" data-dismiss="modal" onclick="return updateMem();">완료</button>
